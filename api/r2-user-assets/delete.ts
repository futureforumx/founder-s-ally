...
import { deleteR2UserAsset, parseR2StoredValue, r2ConfiguredFor } from "../_r2UserAssets.js";
...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    ...
    return res.status(500).json({ error: e instanceof Error ? e.message : "Failed to delete R2 object" });
  }
}
