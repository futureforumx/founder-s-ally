 ...
 *
 * TODO(public-conversion): If you add a different conversion target,
 ...
 */
const SIGNUP_PATH = (import.meta.env.VITE_FRESH_CAPITAL_SIGNUP_PATH as string | undefined)?.trim() || "/access";
