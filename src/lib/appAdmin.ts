...
/** Email domains that automatically receive manager-level admin-console access. */
export const APP_MANAGER_EMAIL_DOMAINS = ["vekta.so", "tryvekta.com"] as const;
export const GOD_MODE_EMAIL = "matt@vekta.so";
...
export function clampGodModeToDesignatedEmail(
