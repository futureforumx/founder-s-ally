...
const RATING_SELECT =
  "id, interaction_type, interaction_date, interaction_detail, score_resp, score_respect, score_feedback, score_follow_thru, score_value_add, nps, comment, anonymous, verified, is_draft, created_at" as const;
