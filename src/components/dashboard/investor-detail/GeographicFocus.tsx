...
export function GeographicFocus({ firmName }: GeographicFocusProps) {
  ...
  return (
    <div className="rounded-xl border border-border bg-card p-4 pb-3 flex flex-col h-full">
      ...
      {/* Stylized SVG Map */}
      <div className="relative w-full aspect-[3/1] rounded-lg bg-secondary/30 border border-border overflow-hidden flex-1 min-h-0">
