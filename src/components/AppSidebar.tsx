      ...
      <aside className="flex h-screen w-44 flex-col bg-sidebar text-sidebar-foreground">
        ...
        <nav className="mt-4 flex flex-1 flex-col gap-1 px-3">
          ...
          <button
            ...
            className={cn("flex items-center gap-2.5 rounded-lg px-3 py-2 text-[13px] font-thin uppercase tracking-wider transition-colors text-sidebar-foreground/70 hover:bg-sidebar-accent/50 hover:text-sidebar-accent-foreground", activeView === item.id && "border")}
          ...
          <button
            ...
            className={cn("flex w-full items-center gap-2.5 rounded-lg px-3 py-2 text-[13px] font-thin uppercase tracking-wider transition-colors mt-3 text-sidebar-foreground/70 hover:bg-sidebar-accent/50 hover:text-sidebar-accent-foreground", (activeView === "directory" || activeView === "groups" || activeView === "events") && "border")}
          ...
          <button
            ...
            className={cn("flex w-full items-center gap-2.5 rounded-lg px-3 py-2 text-[13px] font-thin uppercase tracking-wider transition-colors text-sidebar-foreground/70 hover:bg-sidebar-accent/50 hover:text-sidebar-accent-foreground", activeView === "data-room" && "border")}
        ...
        <div className="border-t border-sidebar-border px-3 py-4">
          <Popover>
            <PopoverTrigger asChild>
              <button
                className={cn("flex w-full items-center gap-2.5 rounded-lg px-3 py-2 text-[13px] font-thin uppercase tracking-wider transition-colors text-sidebar-foreground/60 hover:text-sidebar-foreground hover:bg-sidebar-accent/50", activeView === "settings" && "border")}
