...
// ── Inlined jwtSub (relative imports can't be resolved by MCP bundler) ─────────
...
const ALLOWED_PATCH_FIELDS = new Set([
  ...
  "crunchbase_url", "angellist_url", "pitchbook_url", "openvc_url", "vcsheet_url",
  "wellfound_url", "signal_nfx_url", "tracxn_url",
  "cb_insights_url", "trustfinta_url", "startups_gallery_url",
  // Content & newsletters
  "substack_url", "medium_url", "blog_url", "firm_blog_url", "beehiiv_url",
  // Profile text
  ...
  // Classifications (enum fields)
  "entity_type", "thesis_orientation",
  "sector_classification", "stage_classification",
  "structure_classification", "theme_classification",
  "impact_orientation", "ownership_type",
  // Fund / AUM
...
// Used for both GET list and PATCH return — keeps them in sync.

const SELECT_COLS =
  // Identity & status
  "id, firm_name, legal_name, firm_type, founded_year, " +
  // Contact
  "website_url, email, phone, contact_page_url, " +
  // Location
  "hq_city, hq_state, hq_country, hq_region, address, location, " +
  ...
  // VC Directories
  "crunchbase_url, angellist_url, pitchbook_url, openvc_url, vcsheet_url, " +
  "wellfound_url, signal_nfx_url, tracxn_url, cb_insights_url, trustfinta_url, startups_gallery_url, " +
  // Content / newsletters
  "substack_url, medium_url, blog_url, firm_blog_url, beehiiv_url, " +
  // Profile text
  "description, elevator_pitch, tagline, investment_philosophy, " +
  // Focus arrays
  "sector_focus, stage_focus, geo_focus, thesis_verticals, investment_themes, strategy_classifications, " +
  // Classifications
  "entity_type, thesis_orientation, sector_classification, stage_classification, " +
  "structure_classification, theme_classification, impact_orientation, ownership_type, " +
  // Fund / AUM
  "aum, aum_usd, avg_check_size, min_check_size, max_check_size, " +
  "current_fund_name, current_fund_size, current_fund_vintage_year, num_funds, active_fund_count, " +
  // Portfolio
  "active_portfolio_count, general_partner_count, general_partner_names, partner_names, lead_partner, " +
  // Status / workflow
  "enrichment_status, manual_review_status, needs_review, ready_for_live, verification_status, fund_status, " +
  // Scores
  "completeness_score, data_confidence_score, " +
  // Flags
  "has_fresh_capital, is_actively_deploying, underrepresented_founders_focus, ca_sb54_compliant, " +
  // Media
  "logo_url, " +
  // Timestamps
